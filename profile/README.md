...
**Discord**: [https://discord.gg/2EbveaB2wS](https://discord.gg/2EbveaB2wS)
...
The full reasoning, research agenda, and philosophical context are in the [Charter](https://github.com/Entropic-Science/community/blob/main/CHARTER.md).

## Quick start

1. **Join Discord**: [https://discord.gg/2EbveaB2wS](https://discord.gg/2EbveaB2wS)
2. **Introduce yourself** in `#introductions`
3. **Read** [How we work](https://github.com/Entropic-Science/community/blob/main/HOW_WE_WORK.md) to understand our tools and processes
4. **Start contributing**: see [Contributing guide](https://github.com/Entropic-Science/community/blob/main/CONTRIBUTING.md)

## Documents

| Document | Contents |
|----------|----------|
| [Charter](https://github.com/Entropic-Science/community/blob/main/CHARTER.md) | Mission, scope, motivations, principles, goals |
| [Code of conduct](https://github.com/Entropic-Science/community/blob/main/CODE_OF_CONDUCT.md) | Behavioral standards and enforcement |
